...
function ConferentionsComponent() {
    ...
    return (
        <div className="conferentions-container">
            ...
            <Link to="mentorfind/conferention/conferention_id" className="conferention-button">
            ...
            {isInputIdActive && <div className="conf-id-input">
                ...
                <div className="buttons">
                    ...
                    <Link to="mentorfind/conferention/conferention_id" className="conf-id-button">Приєднатись</Link>
                </div>
            </div>}
        </div>
    );
