...
const Navigation = ({signUpMode, navClasses, Logo, AuthClick, NotAuthClick}) => {
    ...
    return (
      <nav className={`${navClasses} ${signUpMode}`} id="site-nav">
        <Link to="mentorfind/" className="logo-link" onClick={NotAuthClick}>
        ...
        <ul className="nav-list">
          ...
          <li className="nav-list-item">
            <Link to="mentorfind/" className="nav-link" onClick={NotAuthClick}>
              <i
          ...
          {localStorage.getItem('mentorFindToken') !== null && <li className="nav-list-item">
            <Link to="mentorfind/advertform" className="nav-link" onClick={AuthClick}>
              Додати оголошення
            </Link>
          </li>}
          {localStorage.getItem('mentorFindToken') !== null && <li className="nav-list-item">
            <Link to="mentorfind/workingtable" className="nav-link" onClick={NotAuthClick}>
              <i 
          ...
          <li className="nav-list-item">
            <Link to="mentorfind/auth" className="nav-link" onClick={AuthClick}>
              Увійти/Зареєструватись
            </Link>
          </li>}
          {localStorage.getItem('mentorFindToken') !== null && <li className="nav-list-item">
            <Link to="mentorfind/profile" className="nav-link" onClick={NotAuthClick}>
              <i
